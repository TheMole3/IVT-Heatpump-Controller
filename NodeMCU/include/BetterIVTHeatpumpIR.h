...
*/
#ifndef BetterIVTHeatpumpIR_h
#define BetterIVTHeatpumpIR_h
...
#define SHARP_AIRCON2_FULL_EFFECT_ON       0x61 // 0b011 Full power mode on
#define SHARP_AIRCON2_FULL_EFFECT_OFF      0x71 // Full power mode off
#define POWER_FULL_OFF 2
#define POWER_FULL_ON 3


class BetterIVTHeatpumpIR : public HeatpumpIR
{
  public:
    BetterIVTHeatpumpIR();
    void send(IRSender& IR, uint8_t powerModeCmd, uint8_t operatingModeCmd, uint8_t fanSpeedCmd, uint8_t temperatureCmd, bool redo = false);
